...
{
    public class PeerConfigurationService : IPConfigurationService
    {
        #region fields
        private int _port;
...
#pragma warning restore 618
            var endPoint = new ServiceEndpoint(
                ...
                binding,
                new EndpointAddress("net.p2p://FileSharingApp"));
            ...
            if (Communication != null) 
            {
                ...
                catch (PeerToPeerException)
                {
                    ...
                    throw new PeerToPeerException("Error establishing peer service");
                }
            }
            return _isServiceStarted;
        }
